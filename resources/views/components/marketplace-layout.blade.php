...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="public-shell min-h-screen antialiased" x-data="{ mobileMenuOpen: false }">
        ...
        <footer class="footer-stage relative overflow-hidden border-t border-white/15 bg-public-ink text-white" data-reveal>
            <div class="footer-glow footer-glow-two" aria-hidden="true"></div>
            <div class="public-container relative z-10 py-10 sm:py-14">
                <div class="grid gap-10 py-10 sm:grid-cols-2 lg:grid-cols-[1.25fr_0.8fr_0.8fr_1fr]">
                    <div>
                        <a href="{{ route('landing') }}" class="inline-flex items-center gap-3" aria-label="JepretCFD home">
                            <span class="grid h-14 w-14 place-items-center bg-white transition-transform duration-300 hover:-rotate-3">
                                <img src="{{ asset('images/jepret.png') }}" alt="" class="h-12 w-12 object-contain">
                            </span>
                            <span class="text-xl font-extrabold uppercase">JepretCFD</span>
                        </a>
                    ...
                    <div class="text-sm text-white/70">
                        ...
                        <div class="mt-5 flex items-center gap-3">
                            <a href="https://wa.me/6285156767900" target="_blank" rel="noopener noreferrer" class="footer-social grid h-11 w-11 place-items-center border border-white/20" aria-label="WhatsApp JepretCFD" title="WhatsApp">
                            ...
                            <a href="https://instagram.com/jepret.cfd" target="_blank" rel="noopener noreferrer" class="footer-social grid h-11 w-11 place-items-center border border-white/20" aria-label="Instagram JepretCFD" title="Instagram">
                            ...
                            <a href="mailto:jepretccfdd@gmail.com" class="footer-social grid h-11 w-11 place-items-center border border-white/20" aria-label="Email JepretCFD" title="Email">
                ...
                <div class="flex flex-col gap-3 border-t border-white/15 pt-6 text-xs font-semibold text-white/40 sm:flex-row sm:items-center sm:justify-between">
                    <p>&copy; {{ date('Y') }} JepretCFD. All rights reserved.</p>
                    <p>Protected previews &middot; Private originals &middot; Secure downloads</p>
                </div>
            </div>
        </footer>
    </body>
