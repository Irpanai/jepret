        ...
        <aside :class="sidebarOpen ? 'translate-x-0 w-[260px]' : '-translate-x-full w-[260px] lg:translate-x-0 lg:w-[80px]'" 
            ...
            <div class="flex-1 overflow-y-auto py-5 px-3 overflow-x-hidden">
                ...
                <nav class="space-y-1">
                    ...
                    <a href="{{ route('superadmin.photographers.index') }}" :class="sidebarOpen ? 'px-3 justify-start' : 'justify-center'" class="flex items-center gap-3 py-2.5 rounded-lg text-sm font-semibold transition {{ request()->routeIs('superadmin.photographers.*') ? 'bg-black text-white shadow-md' : 'text-gray-600 hover:bg-gray-100' }}" :title="!sidebarOpen ? 'Photographers' : ''">
                        <svg class="w-5 h-5 shrink-0 {{ request()->routeIs('superadmin.photographers.*') ? 'text-white' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2m7-10a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm13 10v-2a4 4 0 0 0-3-3.87m-3-11.26a4 4 0 0 1 0 7.75"/></svg>
                        <span x-show="sidebarOpen" class="whitespace-nowrap">Kreator</span>
                    </a>
